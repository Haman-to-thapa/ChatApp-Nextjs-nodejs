...
import type { AuthentictedRequest } from "../middleware/isAuth.js";
...
export const updateName = TryCatch(async(req:AuthentictedRequest, res) => {
...
export const getAllUsers = TryCatch(async(req:AuthentictedRequest, res) => {
